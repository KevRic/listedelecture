      ...
      <Router>
        <Container>
          ...
          <Switch>
            ...
            <RoutePriveeAdmin path="/ajouter" component={PageAjouter} />
            <RoutePriveeAdmin path="/modifier/:id" component={PageModifier} />
            <RoutePriveeAdmin path="/supprimer/:id" component={PageSupprimer} />
